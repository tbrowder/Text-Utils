...
width (default: 78) and returns a list of the new paragraph's lines
formatted as desired. A new option, C<:$line-pre-text>, is very useful
for use in autp-generation of code. For example, given this chunk
of text describing a following method:
...
B<THIS ROUTINE IS DEPRECATED - USE WRAP-PARAGRAPH FOR NEW CODE>
